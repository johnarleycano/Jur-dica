        ...
        <tr>
            ...
            <td rowspan="5">
                <table width="80%">
                    ...
                    <tr>
                        <td><b>Valor del contrato: </b></td>
                        <td style="text-align: right"><?php echo '$ '.number_format($estado->Valor_Inicial, 0, '', '.'); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><b>Saldo: </b></td>
                        <td style="text-align: right"><?php echo '$ '.number_format($estado->Saldo, 0, '', '.'); ?></td>
                    </tr>
                    <tr>
                        <td><b>Retenido: </b></td>
