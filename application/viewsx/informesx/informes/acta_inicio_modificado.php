...
$tabla5 = array('borderSize' => 8, 'borderColor' => '1E1E1E',  'cellMarginTop' => 200, 'rules' => 'cols');
...
$PHPWord->addTableStyle('tabla2', $tabla2);
$table = $seccion1->addTable('tabla2');
$table->addRow();
$table->addCell(4000, $styleCell)->addText('CONTRATANTE', 'parrafo1', $alineacion_izquierda);
$table->addCell(10000, $styleCell)->addText('ACTA DE INICIO DE OBRA', 'parrafo2', $alineacion_centrada);
$table->addCell(10000, $styleCell)->addText('ACTA DE INICIO DE OBRA', 'parrafo2', $alineacion_centrada);
$table->addRow();
$table->addCell(4000, $styleCell)->addText('CONTRATISTA', 'parrafo1', $alineacion_izquierda);
$table->addCell(10000, $styleCell)->addText('ACTA DE INICIO DE OBRA', 'parrafo2', $alineacion_centrada);
$table->addCell(10000, $styleCell)->addText('ACTA DE INICIO DE OBRA', 'parrafo2', $alineacion_centrada);
$table->addRow();
$table->addCell(4000, $styleCell)->addText('OBJETO', 'parrafo1', $alineacion_izquierda);
$table->addCell(10000, $styleCell)->addText('MANTENIMIENTO Y CONSERVACIÓN RUTINARIA DE LA RED VIAL CONCESIONADA A DEVIMED EN EL SECTOR ALTO DE LA SIERRA - RETORNO No 12 LA PLAYA, DE LA AUTOPISTA MEDELLÍN – BOGOTÁ.', 'parrafo2', $alineacion_justificada);
$table->addCell(10000, $styleCell);
$table->addRow();
$table->addCell(4000, $styleCell)->addText('PLAZO', 'parrafo1', $alineacion_izquierda);
$table->addCell(10000, $styleCell)->addText('PLAZO', 'parrafo2', $alineacion_justificada);
$table->addCell(10000, $styleCell);
$table->addRow();
$table->addCell(4000, $styleCell)->addText('VALOR', 'parrafo1', $alineacion_izquierda);
$table->addCell(10000, $styleCell)->addText('VALOR', 'parrafo2', $alineacion_justificada);
$table->addCell(10000, $styleCell);
...
foreach ($contratos as $contrato):
	...
	$table = $seccion1->addTable('tabla2');
	$table->addRow();
	$table->addCell(13000)->addText(utf8_decode('DATOS GENERALES DEL CONTRATO'), 'parrafo1', $alineacion_centrada);	
	$seccion1->addTextBreak();
	
	$seccion1->addText(utf8_decode('El '.$this->auditoria_model->formato_fecha(date('Y-m-d')).', en las oficinas de DEVIMED S.A, ubicadas en el municipio de Medellin (Antioquia), se reunieron el ingeniero GERMAN IGNACIO VELEZ VILLEGAS quien actúa en representación de DEVIMED S.A (Contratante), y '.$contrato->Representante_Legal.', quien obra en representación de '.$contrato->Contratista.', con el  fin de suscribir el acta de inicio de obra, para efectos de determinar el inicio del plazo del Contrato N° '.$contrato->Numero.', cuyo objeto es el siguiente: '), 'estilo2', $alineacion_justificada);
...
$seccion1->addText(utf8_decode('V.B. CUMPLIMIENTO DE REQUISITOS PREVIOS AL INICIO POR PARTE DE SISO ___'), 'titulo2', $alineacion_izquierda);
$seccion1->addTextBreak();

$seccion1->addText(utf8_decode('Para constancia, se firma la presente acta por los que en ella intervinieron:'), 'parrafo2', $alineacion_justificada);
