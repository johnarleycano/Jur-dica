 ...
 */
Class Bitacora_demanda extends CI_Controller{
    /**
   ...
   function __construct() {
        ...
        $this->load->model('bitacora_demanda_model');
   }//Fin construct()
    ...
    */
    function index(){
        ...
        $this->data['id_demanda'] = $this->uri->segment(3);
        $this->data['bitacoras'] = $this->bitacora_demanda_model->listar_bitacora($id_demanda);
        
        //se establece el titulo de la p&aacute;gina
        $this->data['titulo'] = 'Demandas - Bit&aacute;cora';
        //se establece la vista que tiene el contenido principal
        $this->data['contenido_principal'] = 'bitacora/bitacora_demanda_view';
   ...
   function agregar(){
        ...
        */
        ...
        if($this->form_validation->run() == false){
            ...
            $this->data['mensaje_alerta'] = "Hacen falta algunos datos necesarios<br> para guardar en bitacora. Verifique por favor";
            $this->index();
        }else{
            /*
            ...
            $bitacora = array(
                ...
                'Fk_Id_Demanda' => $this->input->post('id_demanda'),
            ...
            print_r($bitacora);
            //Estos datos se insertan en la tabla demanda_bitacora mediante este modelo
            $this->bitacora_demanda_model->agregar_bitacora($bitacora);
            ...
            //se establece el titulo de la p&aacute;gina
            $this->data['titulo'] = 'Demanda - Bit&aacute;cora';
            //se establece la vista que tiene el contenido principal
            $this->data['contenido_principal'] = 'bitacora/bitacora_demanda_view';
            //se carga el template
            $this->load->view('includes/template', $this->data);
