...
foreach ($contratos as $contrato):
	...
	$seccion1->addText(utf8_decode('$ '.number_format($contrato->Valor_Inicial + $contrato->Valor_Adiciones,2,',','.').' ('.$numero->traducir($contrato->Valor_Inicial + $contrato->Valor_Adiciones).')'), 'parrafo2', $alineacion_justificada);
	$seccion1->addTextBreak();
